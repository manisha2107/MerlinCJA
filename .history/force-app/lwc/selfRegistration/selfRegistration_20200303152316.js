...
export default class CreateRecordInLWC extends LightningElement {
    ...
    handleUsernameChange(event) {
        this.accRecord.Username = event.target.value;
        window.console.log('Username ==> '+ this.accRecord.Username);
    }
    ...
    handleSave() {
        ...
        console.log('Account Record::' +JSON.stringify(this.accRecord.Username) );
