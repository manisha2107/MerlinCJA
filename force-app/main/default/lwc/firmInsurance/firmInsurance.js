...
import Customer_Community_Status__c_FIELD from '@salesforce/schema/User.Customer_Community_Status__c';
...
export default class FirmInsurance extends NavigationMixin(LightningElement) {
    ...
    */
    ...
    updateFirmAccount({accName:this.firmName,Mailingst:this.firmStreet,Mailingcity:this.firmCity,Mailingstate:this.firmState,
     ...
     getEndorsement({quoteId:this.policyRec.Quote__c,province:this.firmRec.ShippingState})
        ...
        .catch(error => {
            ...
            .then(result => {      
                ...
                if(result){
                    ...
                    console.log('firm insurance exist in if?::: ' + this.firminsuranceexist);
                    ...
                    console.log('firm insurance exist in else?::: ' + this.firminsuranceexist);
      ...
      handlePolicySave() {
        console.log('firm insurance status:::' + this.firminsuranceexist);    
        console.log('Premium Amount when created ===>' + this.premiumPerMonth);      
        ...
        console.log('policy already exist, heres the record detail ====>' + JSON.stringify(this.firmPolicyRec));
                console.log('Updated Premium Amount ===>' + this.premiumPerMonth);      
                console.log('Firm Policy Id ===>' + this.firmPolicyRec.Id);      
    ...
    //   fields[USER_COMPANY_NAME.fieldApiName] = 'test company';
       fields[USER_COMMUNITY_STATUS.fieldApiName] = 'Mid-Term Changes with Firm Rider';
   //    fields[USER_DEPARTMENT.fieldApiName] = 'test department';
...
/*
       let record = {fields: {Id:userId,Customer_Community_Status__c:'TEST STATUS'},};
        updateRecord(record)
            // eslint-disable-next-line no-unused-vars
            .then(() => {
                 
                this.dispatchEvent(new ShowToastEvent({title: 'Success',message: 'User Record Is Updated',variant: 'success',}),);
