...
export default class ParentNavigation extends NavigationMixin(LightningElement) {
  ...
  NavigateToProperPage() {
    ...
    if (this.accRecord.Application_Current_Stage__c == 'Personal Information') {
    ...
    if (this.Design != 'Mid-Term') {
      ...
      getBuisnessLicenseData({ AccId: this.accRecord.Id })
        .then(result => {
          ...
          //     TotalAnnualEarning: result[i].Total_Annual_Earning__c,
          //     PercentageOfTotalIncome: result[i].Percentage_Of_Total_Income__c,
          //     Id: i
          //   })
          // }
          // this.splitlicensesList = arr
  ...
  navigateToQuoteInfo(event) {
    ...
    this.template.querySelector("c-quote").childFunction(this.accRecord, policy, PPD, transactionFee,this.Design);
