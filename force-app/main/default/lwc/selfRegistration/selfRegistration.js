        ...
        if(this.checkIfError()){
            ...
            // if(!result){
                ...
                .then(result => {
                    ...
                    this.success = 'Your account has created successfully, please check your email to proceed further.'
                })
                .catch(error => {
                    console.log(error)
                    this.error = error.message;
                    this.emailError = 'Email already exists! Please login from your credentials or contact your Insurance Broker';
